...
from game_functions import introduction, get_user_input, evaluate_guess
from game_functions import get_plurals, calculate_time, highscore, end_credits
...
def play_game(divider: str):
    ...
    print(end_credits(divider, mins, secs, high_score))
