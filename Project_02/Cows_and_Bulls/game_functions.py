...
def highscore(score: int) -> int:
    ...
    try:
        with open(r'highscore.txt', 'r', encoding='UTF-8') as file:
    ...
    with open (r'highscore.txt', 'w', encoding='UTF-8') as file:
        file.write(str(high_score))

    return int(high_score)


def end_credits(divider: str , mins: int, secs: int, high_score: int) -> str:
